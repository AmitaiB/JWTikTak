...
public class SettingsTableViewController: UITableViewController {
    ...
    override public func viewDidLoad() {
        ...
        self.tableView.registerCell(cell: TextSettingCell.self)
        self.tableView.registerCell(cell: ButtonSettingCell.self)
    ...
    private static var registeredTypes: [ObjectIdentifier: SettingCell.Type] = [
        ...
        ObjectIdentifier(TextSetting.self): TextSettingCell.self,
        ObjectIdentifier(ButtonSetting.self): ButtonSettingCell.self
    ]
